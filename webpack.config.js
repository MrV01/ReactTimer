...
///  1.  Files   ''\.(css|sass)$''    are going through SASS  processing
//    2. Files "\.pscss$" are going throug  PostCSS processing
///  3.  CSS Files SASS and PostCSS generates into  separate bundles
//
// node's native package 'path' https://nodejs.org/api/path.html
...
const config =  {
  entry:[
    ...
    //Foundation file from NODE_MODULES
...
// Automatically generate JS source maps for a browser development tools.
